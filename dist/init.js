...
async function main() {
    ...
    const vendorProd = manifest.vendor;
    ...
    const findDefault = (...names) => names.find((n) => branches.includes(n)) ?? branches[0];
    // Mapeo de ramas
